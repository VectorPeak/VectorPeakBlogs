...
### 2.3 IVF\_SQ8 / IVF\_PQ — 倒排索引 + 量化压缩
...
## 第四部分：langchain-milvus 如何实现混合检索
...
### 4.3 similarity\_search\_with\_score() 的隐藏操作
...
## 第五部分：langchain-milvus 与 PyMilvus 的职责边界
