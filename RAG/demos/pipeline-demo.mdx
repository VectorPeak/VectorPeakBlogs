---
title: "Pipeline 执行流程动画"
description: "整理 RAG Pipeline 执行流程动画中的阶段、步骤和关键链路"
icon: "circle-play"
---
...
### 8. 🧠 Stage 2c：兜底 direct_answer 检查
...
### 12. 📄 Stage 4b：CrossEncoder Reranker 精排
...
### 20. 🧭 Stage 1：查询路由 — route=faq_exact
