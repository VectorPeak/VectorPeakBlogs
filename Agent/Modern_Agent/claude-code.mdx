...
---
## Claude Code
<Badge icon="clock" color="green">Written: 2026.05</Badge> Claude Code 本身就是 T0 级别的 Vibe Coding 工具，非常值得大家学习。不要把视野只局限在自己公司的工具上，比如腾讯内部可能会用 CodeBuddy，但不同工具之间的差异其实很大
...
~~~text title="目录结构" icon="folder-tree"
.claude/rules/
