...
```python title="预构建 Agent 实现记忆存储" icon="python"
import dotenv
...
```console title="第二轮（继续同一 thread）" icon="terminal"
================================== Ai Message ==================================
...
```python title="底层 API 实现记忆存储" icon="python"
...
```console title="第二次对话：基于上下文询问用户信息" icon="terminal"
================================== Ai Message ==================================
...
```python title="长期记忆+跨线程召回" icon="python"
import uuid
from typing import TypedDict, Annotated
import dotenv
from langchain_ollama import ChatOllama
...
```console title="第二次交互测试：验证是否能回忆起之前的信息" icon="terminal"
第一次回复：
================================== Ai Message ==================================
...
```console title="定义工具列表，" icon="terminal"
================================== Ai Message ==================================
...
```console title="查询用户姓名和兴趣，测试模型对上下文的理解能力" icon="terminal"
================================== Ai Message ==================================
