...
description: "介绍 LangGraph、LangSmith、Studio、CLI 和 Agent Chat UI 的协作方式"
icon: "boxes"
---
...
```python title="创建相关文件" icon="python"
...
```python title="创建ReAct代理，结合语言模型和工具函数" icon="python"
{
  "dependencies": [
    "./"
  ],
...
```python title="安装langgraph-cli 并启动项目" icon="python"
# langgraph dev
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1758202778275-5d5e83e3-bbdc-4bad-8e39-ddab356e89dc.png)
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1758203523646-a1049ed6-d7a4-4058-b89e-21514bb29c48.png)

### 4.3 LangSmith 追踪

点击`LangGraph Studio`侧边栏的`Tracing Projects`按钮，然后点击我们的项目`langgraph_studio_chatbot`，可以看到LangSmith的调试记录:

![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1758203607004-2c5ba0ef-c73c-4175-bb25-74d45a97900e.png)
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1758338510167-e2c42c1e-69c3-4958-82c1-2a6b357ed86c.png)

聊天测试进行功能验证

![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1758338599006-ff471e09-9010-4d22-af62-c7536edb98fa.png)
