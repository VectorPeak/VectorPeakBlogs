...
```console title="启动服务" icon="terminal"
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1757772232885-01489bf0-3763-4a0c-afa4-59182d170c17.png)

### 4.3 访问程序 web 页面

直接访问[http://127.0.0.1:8000/translation/playground/](http://127.0.0.1:8000/translation/playground/)即可通过浏览器进行交互

![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1757772295185-3f104cbe-adf7-4a04-8fd4-ace10de86c47.png)
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1757772751329-642f41b3-4fb9-4581-9ea7-fa35b356896b.png)

访问验证：

```python title="访问 API 接口" icon="python"
curl -X 'POST' \
...
```console title="客户端访问" icon="terminal"
Bonjour
```
