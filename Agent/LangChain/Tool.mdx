...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1754212299090-2a23d847-e779-41b0-81a9-dbc1587cb5c5.png)
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1763902365020-ebd967fe-cd88-43f6-8d21-e798c69c6d42.png)
...
```python title="使用内置 Tool" icon="python"
...
```console title="调用工具执行加法运算" icon="terminal"
...
```console title="StructuredTool实现" icon="terminal"
...
```python title="定义 Tool" icon="python"
from langchain_core.tools import tool
import json
import os
import httpx
...
```python title="大模型调用 Tool" icon="python"
import dotenv
