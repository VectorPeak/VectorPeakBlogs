...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1761401570754-68908952-d1d3-4849-b04f-3b79bc4226f1.png)
...
```console title="打印类型" icon="terminal"
...
```console title="解析结果" icon="terminal"
