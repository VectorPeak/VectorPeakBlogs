...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1753667354595-e33b518e-53a7-4481-b5c4-6ff1cbbfa5ef.png)

系统中默认存在一个项目，我们新建一个项目。

![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1753667411520-697ccd04-0e17-4066-98d9-225a7ceeff18.png)

LangSmith支持LangChain项目和非LangChain项目，并且分别提供了将LangSmith接入到应用的方法，点击Generate API Key，生成API Key。

![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1753667505220-64da8d32-e4f5-40de-b8a8-339bdd2c4531.png)

### 3.2 复制环境变量配置

复制上方的配置，放到项目的.env 文件中

```python title="复制环境变量配置" icon="python"
...
执行完成之后，在Tracing Projects页面就可以看到`langchain-demo`项目被成功创建

![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1753668479011-285aee06-ef08-438e-8261-3b4570b09b2f.png)

点击进入项目，就可以看到刚刚那一次的调用过程，包括输入、输出、发起时间、总耗时等信息

![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1753668502995-05b91b09-8d2d-4495-a05e-7e419fe58780.png)

点击All Runs可以查看各个组件的执行过程，包括Prompt生成、LLM响应、输出解析器处理等各环节的详细执行信息

![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1753668677996-70416418-a660-4ee7-90e7-30781433260f.png)
