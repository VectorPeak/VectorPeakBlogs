...
```python title="为什么需要记忆存储" icon="python"
...
```console title="执行链式调用" icon="terminal"
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1761984911018-de159b93-df1b-49f9-934d-85473464d322.png)
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1762678952595-c7df6603-ffcc-4e62-b89f-5b06f99f8f46.png)
...
```console title="遍历并输出所有聊天历史记录中的消息内容" icon="terminal"
...
```python title="LCEL调用" icon="python"
from langchain_core.chat_history import InMemoryChatMessageHistory
from langchain_core.output_parsers import StrOutputParser
...
```console title="配置运行时参数，设置会话ID" icon="terminal"
...
```python title="**记忆窗口裁剪**" icon="python"
from langchain_core.chat_history import InMemoryChatMessageHistory
...
```python title="Redis存储" icon="python"
...
```python title="pip install langchain-redis redis" icon="python"
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1762682406308-73f65223-90f7-43f1-83ca-2be00c9f2111.png)

![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1762682431196-437cb07c-1635-4f57-b5f4-b80e9d1bd930.png)
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1762698133462-c3f941a8-d99c-4dc0-8f94-932d774fe25f.png)

### 5.4 代码实现

完整代码如下

```python title="代码实现" icon="python"
from langchain_core.runnables import RunnableConfig
from langchain_ollama import ChatOllama
from langchain_core.prompts import ChatPromptTemplate, MessagesPlaceholder
from langchain_core.runnables.history import RunnableWithMessageHistory
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1753947749071-2f681c63-1ee6-4bfa-88a7-0a4b612292e8.png)
