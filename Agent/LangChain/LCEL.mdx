...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1752810484524-ccdab3bb-0ade-4e3c-9f30-53f820e7feee.png)
...
![](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/png/2308212/1761534001753-fc3fdc99-6e49-4257-b33f-faf6dc352fec.png)
...
![画板](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/jpeg/2308212/1761701477779-2899ce71-fe6c-4fbc-a4eb-c533fc24ba71.jpeg)

代码如下

```python title="分支链" icon="python"
from langchain_core.output_parsers import StrOutputParser
from langchain_core.prompts import ChatPromptTemplate
...
```console title="测试查询" icon="terminal"
...
![画板](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/jpeg/2308212/1761702359302-2077b5ee-669a-44e6-ba74-55c26abec6d4.jpeg)

代码如下：

```python title="串行链" icon="python"
from langchain_core.output_parsers import StrOutputParser
from langchain_core.prompts import ChatPromptTemplate
from langchain_ollama import ChatOllama
from loguru import logger
...
```console title="调用复合链" icon="terminal"
...
![画板](https://api.cuiliangblog.cn/v1/public/imgProxy/?url=https://cdn.nlark.com/yuque/0/2025/jpeg/2308212/1761702359600-fe66a419-b187-432a-b625-1bb65485a8f3.jpeg)
...
```console title="函数转可执行链" icon="terminal"
from langchain_core.output_parsers import StrOutputParser
from langchain_core.prompts import ChatPromptTemplate
...
```console title="执行链" icon="terminal"
...
```python title="图形化打印链图" icon="python"
from langchain_core.output_parsers import StrOutputParser
from langchain_core.prompts import ChatPromptTemplate
from langchain_ollama import ChatOllama
from langchain_core.runnables import RunnableParallel
